...
class DoctorVerificationSuccess extends Component {
        constructor(props) {
            super(props)
            this.state= {
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="col-10 offset-4 col-sm-10 offset-sm-4 col-md-10 offset-md-4 col-lg-10 offset-lg-4">
                                                <form onSubmit={this.resendEmailHandler} className={this.state.verification.display}>
                                                    ...
                                                    <input type="email" placeholder="Enter your mail" required  className="form-control" />
                                                    <input type="submit" value="Re-Send Mail" className="btn btn-sm btn-medik" />
                                                    </div>
                                                </form>
                                                <Link to="/doctor/dashboard" className={this.state.verification.dashboardDisplay}>
...
export default DoctorVerificationSuccess;