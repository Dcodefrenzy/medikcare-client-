...
class DoctorForgetPassword extends Component {
    constructor(props) {
        super(props)
        this.state= {
    ...
    sendEmailHandler = ( event ) => {
       ...
       let userData = {};
       const url = "/api/v1/doctor/forget/password";
    const email = this.state.email.value;
       userData = {"email":email};
        ...
        .catch(e => {
        if(e) {window.location = "/doctor/forget/password?something-went-wrong-please-check-your-internet-connection-and-try-again."}
        });
    }
    onLoadHandler = (event) => {
                    ...
                    <div className="col-12 col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                        <div className="card">
                            ...
                            <form onSubmit={this.sendEmailHandler}>
                                ...
                                <span>Go back to</span> <Link to="/doctor/login"><button className="btn-sm medik-color-secondary b-medik">Login</button></Link>
