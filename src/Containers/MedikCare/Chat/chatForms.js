                                            ...
                                            <div className="row">
                                                <div className="col-8">
                                                    <div className="form-group"> 
                                                        <textarea onKeyPress={event => whoIsTyping(event)} onKeyDown={event=>notTyping(event)} name="chat"  ref={textElement} className="form-control chat-message" placeholder="Write a message" rows="1" required></textarea>
                                                        </div>
                                                </div>
                                                <div className="col-4">
